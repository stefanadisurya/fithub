...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String insertExerciseTable = "INSERT INTO exercises(name, minute, description, image)" + "VALUES ('Full Body', '10', 'Full body workout'," + R.drawable.thumb4 + ")," + "('Lower Body', '12', 'Lower body workout'," + R.drawable.thumb3 +")," + "('Arm', '15', 'Arm workout'," + R.drawable.thumb2 + ")," + "" + "('Chest', '15', 'Chest workout'," + R.drawable.thumb5 +")";
        ...
        String insertTypeTable = "INSERT INTO types(ex_id, name, description, reps, image) " +
                ...
                "('4', 'Push-ups', 'Placing your arms shoulder-width apart and palms firmly rooted to the ground, bend your arms, lowering your chest to the floor while keeping your body straight. Once your chest is close enough to touch the floor, push yourself back up to the start position. Additionally, ensure that your elbows are at a 45° angle from your body, and that your arms are bent at a 90° angle when lowering your body.', '12', "+ R.drawable.thumb5 + "), " +
                "('4','Incline Push-ups', 'An incline pushup is an elevated form of a traditional pushup. Your upper body is elevated with an exercise box or other piece of equipment.', '12', "+ R.drawable.thumb5 + "), " +
                "('4', 'Mountain Climber Pushup', 'Start in a high plank. Perform one pushup. Then, pull right knee toward chest, return to start, and quickly do the same with the left to perform a mountain climber. Continue alternating for a count of four total.', '12', "+ R.drawable.thumb5 + "), " +
                "('4', 'Pull Up', 'Grab the bar with an overhand grip. Hanging from the bar, pull your shoulder blades back and down to lift your body up and build momentum. Finish by pulling up with your arms.', '10', "+ R.drawable.thumb5 + "), " +
                "('4', 'Burpee', 'From a standing position, squat, place you hands on the ground, and “jump” your feet out into a pushup position. Perform a pushup, and then jump your feet to your hands. Then jump as high as you can, throwing your hands over your head.', '14', "+ R.drawable.thumb5 + ")";

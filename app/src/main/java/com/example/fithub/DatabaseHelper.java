...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String insertTypeTable = "INSERT INTO types(ex_id, name, description, reps, image) " +
                ...
                "('2', 'Air Squats', 'Keep your feet at shoulder width apart and pointed straight ahead. When squatting, your hips will move down and back. Your lumbar curve should be maintained, and your heels should stay flat on the floor the entire time. In air squats, your hips will descend lower than your knees.', '30', "+ R.drawable.thumb4 + "), " +
                "('2', 'Jumping Jacks','A physical jumping exercise performed by jumping to a position with the legs spread wide and the hands going overhead, sometimes in a clap, and then returning to a position with the feet together and the arms at the sides.', '30', "+ R.drawable.thumb4 + ")," +
                "('2', 'Lunge Kicks', 'Stand straight, face front, keep your core tight and your back flat. As you lunge, keep the front knee aligned with the ankle and keep your weight loaded in the front heel. Exhale as you kick, and then return to the starting position or go directly into a new lunge.', '16', "+ R.drawable.thumb4 + ")," +
                "('2', 'Step-ups', 'Stand straight, face front, keep your core tight and your back flat. As you lunge, keep the front knee aligned with the ankle and keep your weight loaded in the front heel. Exhale as you kick, and then return to the starting position or go directly into a new lunge.', '25', "+ R.drawable.thumb4 + ")," +
                "('2', 'Side Leg Lift', 'Stand upright with your toes facing forward. As you lift your right leg up off the floor with the foot flexed, inhale and shift the weight into your left foot. As you exhale, bring the leg back down to meet the left. Repeat 10-12 times, then switch to the other side.', '24', "+ R.drawable.thumb4 + ")," +
                ...
                "('3', 'Bicep Curl', 'Start standing with a dumbbell in each hand. Your elbows should rest at your sides and your forearms should extend out in front of your body. Your knees should stay slightly bent and your belly button should draw into the spine. Bring the dumbbells all the way up to your shoulders by bending your elbows. Once at the top, hold for a second by squeezing the muscle. Reverse the curl slowly and repeat.', '20', "+ R.drawable.thumb4 + "), " +
                "('3', 'Dips', 'Sit on a chair or bench with hands just outside of the hips and the knees bent or the legs extended straight out (harder). Lift up onto the hands and, keeping the hips very close to the chair or bench, bend the elbows, lowering down until they are at about 90 degrees. Keep the elbows pointing behind you, the shoulders down and the abs engaged. Push back to start and repeat.', '16', "+ R.drawable.thumb4 + "), " +
                "('3', 'Superman', 'Lie on your stomach with your arms and legs extended. Engage your glutes and shoulders as you simultaneously lift your arms, chest, and legs off of the floor. Hold this upward position for 3 seconds. You’ll look like superman or superwoman flying through the air. Slowly come back down to starting position.', '16', "+ R.drawable.thumb4 + "), " +
                "('4', 'Push-ups', 'Placing your arms shoulder-width apart and palms firmly rooted to the ground, bend your arms, lowering your chest to the floor while keeping your body straight. Once your chest is close enough to touch the floor, push yourself back up to the start position. Additionally, ensure that your elbows are at a 45° angle from your body, and that your arms are bent at a 90° angle when lowering your body.', '12', "+ R.drawable.thumb4 + "), " +
                "('4','Incline Push-ups', 'An incline pushup is an elevated form of a traditional pushup. Your upper body is elevated with an exercise box or other piece of equipment.', '12', "+ R.drawable.thumb4 + "), " +
                "('4', 'Mountain Climber Pushup', 'Start in a high plank. Perform one pushup. Then, pull right knee toward chest, return to start, and quickly do the same with the left to perform a mountain climber. Continue alternating for a count of four total.', '12', "+ R.drawable.thumb4 + "), " +
                "('4', 'Pull Up', 'Grab the bar with an overhand grip. Hanging from the bar, pull your shoulder blades back and down to lift your body up and build momentum. Finish by pulling up with your arms.', '10', "+ R.drawable.thumb4 + "), " +
                "('4', 'Burpee', 'From a standing position, squat, place you hands on the ground, and “jump” your feet out into a pushup position. Perform a pushup, and then jump your feet to your hands. Then jump as high as you can, throwing your hands over your head.', '14', "+ R.drawable.thumb4 + ")";
